...
use Aanshi\LaravelJsLocalization\Commands\LangJsCommand;
...
class LangJsCommandTest extends TestCase
{
    ...
    public function testShouldCommandRun()
    {
        ...
        $template = "$this->rootPath/src/Aanshi/LaravelJsLocalization/Generators/Templates/langjs_with_messages.js";
    ...
    {
        $template = "$this->rootPath/src/Aanshi/LaravelJsLocalization/Generators/Templates/messages.js";
        $this->assertFileExists($template);
